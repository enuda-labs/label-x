...
from .models import SubscriptionPlan, UserDataPoints, UserPaymentHistory, UserSubscription, Wallet



class UserDataPointsSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserDataPoints
        fields = '__all__'
...
class SubscriptionPlanSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["id", "name", "monthly_fee", "cost_per_extra_request", 'included_data_points', 'features']


class UserSubscriptionSimpleSerializer(serializers.ModelSerializer):
    class Meta:
